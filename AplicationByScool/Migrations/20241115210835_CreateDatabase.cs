        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailAddres = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserNameParent = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailAddres = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ClassTeacher = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MiddleName = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    Classroom = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Number = table.Column<int>(type: "int", nullable: false),
                    FormOfTraining = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_ClassTeacher",
                table: "Teachers",
                column: "ClassTeacher",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Teachers_EmailAddres",
                table: "Teachers",
                column: "EmailAddres",
                unique: true);
